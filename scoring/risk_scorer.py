...
class RiskScorer:
    ...
    BASE_RISK_SCORES = {
        ...
        'duplicate_spn': 50,
        'kerberos_legacy_encryption': 80,
        'privileged_account_delegatable': 80,
        ...
        'reversible_encryption_enabled': 95,
        'privileged_user_outside_protected_users': 75,
        'privileged_user_without_smartcard': 55,
        ...
        'weak_fine_grained_password_policy': 75,
        ...
        'ldap_anonymous_enabled': 90,
        'ldap_prewin2k_broad_membership': 75,
        'ldap_guest_enabled': 70,
        'ldap_legacy_functional_level': 40,
        'hidden_primary_group_privilege': 95,
        'privileged_computer_account': 80,
        'builtin_admin_renamed': 35,
        'hybrid_azure_sso_account': 85,
        'hybrid_entra_connect_account': 90,
        'hybrid_adfs_service': 80,
        'hybrid_join_not_observed': 15,
        'rodc_missing_never_reveal': 75,
        'rodc_privileged_reveal': 95,
        'rodc_broad_revealed_secrets': 50,
        'rodc_allowed_group_privileged': 80,
        'dmsa_schema_enabled': 55,
        'dmsa_predecessor_link': 95,
        'dmsa_object_present': 60,
        'sccm_system_management_present': 70,
        'sccm_management_point': 55,
        'windows_laps_not_deployed': 50,
        'windows_laps_plaintext': 80,
        'certificate_esc15': 85,
        'certificate_esc16': 80,
    }
    ...
    def _generate_executive_description(self, risk):
        ...
        descriptions = {
            ...
            'disabled_domain_admin': f"Disabled account '{affected}' is still a Domain Admin. Re-enabling it restores domain-wide administrative rights.",
            'disabled_enterprise_admin': f"Disabled account '{affected}' is still an Enterprise Admin. Re-enabling it restores forest-wide administrative rights.",
