...
ANALYSIS_DISPLAY_LABELS = {
    ...
    "authentication_policy_risks": "Authentication Policy and Silo",
    "key_credential_forensic_risks": "KeyCredentialLink forensics",
    "windows_laps_v2_risks": "Windows LAPS v2",
    "certificate_mapping_risks": "Strong certificate mapping",
    "kerberos_rc4_readiness_risks": "Kerberos RC4 retirement readiness",
    "adminsdholder_drift_risks": "AdminSDHolder / SDProp drift",
    "gmsa_reader_graph_risks": "gMSA effective password-reader graph",
    "adcs_control_plane_risks": "AD CS control-plane ACL graph",
    "trust_security_v2_risks": "Trust Security v2",
    "ad_dns_security_risks": "AD-integrated DNS security",
    "hybrid_identity_v2_risks": "Hybrid identity control plane",
    "attack_graph_v2_risks": "Tier-0 attack graph v2",
    "event_correlation_risks": "Offline event correlation",
    "posture_evidence_risks": "DC/GPO posture evidence",
    "snapshot_delta_risks": "Security snapshot delta",
