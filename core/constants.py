...
class RiskTypes:
    ...
    # Modern identity protections (Package A)
    AUTH_POLICY_NOT_DEPLOYED = 'auth_policy_not_deployed'
    AUTH_POLICY_AUDIT_ONLY = 'auth_policy_audit_only'
    AUTH_POLICY_BROKEN_ASSIGNMENT = 'auth_policy_broken_assignment'
    AUTH_POLICY_EXCESSIVE_TGT_LIFETIME = 'auth_policy_excessive_tgt_lifetime'
    AUTH_POLICY_PRIVILEGED_UNPROTECTED = 'auth_policy_privileged_unprotected'
    KEY_CREDENTIAL_MALFORMED = 'key_credential_malformed'
    KEY_CREDENTIAL_ANOMALY = 'key_credential_anomaly'
    KEY_CREDENTIAL_PRIVILEGED = 'key_credential_privileged'
    KEY_CREDENTIAL_DUPLICATE_DEVICE = 'key_credential_duplicate_device'
    WINDOWS_LAPS_ENCRYPTION_GAP = 'windows_laps_encryption_gap'
    WINDOWS_LAPS_DSRM_NOT_BACKED_UP = 'windows_laps_dsrm_not_backed_up'
    WINDOWS_LAPS_HISTORY_DISABLED = 'windows_laps_history_disabled'
    WINDOWS_LAPS_BROAD_ACL = 'windows_laps_broad_acl'
    CERTIFICATE_WEAK_EXPLICIT_MAPPING = 'certificate_weak_explicit_mapping'
    CERTIFICATE_SID_EXTENSION_DISABLED = 'certificate_sid_extension_disabled'
    KERBEROS_RC4_ONLY = 'kerberos_rc4_only'
    KERBEROS_AES_READINESS_UNKNOWN = 'kerberos_aes_readiness_unknown'
    ADMINSDHOLDER_DANGEROUS_ACE = 'adminsdholder_dangerous_ace'
    ADMINSDHOLDER_ACL_DRIFT = 'adminsdholder_acl_drift'
    ADMINSDHOLDER_ORPHANED_ADMINCOUNT = 'adminsdholder_orphaned_admincount'
    ADMINSDHOLDER_INHERITANCE_ENABLED = 'adminsdholder_inheritance_enabled'

    # Advanced attack-surface analysis (Package B)
    GMSA_BROAD_PASSWORD_READER = 'gmsa_broad_password_reader'
    GMSA_PRIVILEGED_READER_PATH = 'gmsa_privileged_reader_path'
    GMSA_EXCESSIVE_EFFECTIVE_READERS = 'gmsa_excessive_effective_readers'
    ADCS_CONTROL_PLANE_ACL = 'adcs_control_plane_acl'
    ADCS_NTAUTH_ACL = 'adcs_ntauth_acl'
    TRUST_SELECTIVE_AUTH_DISABLED = 'trust_selective_auth_disabled'
    TRUST_SID_FILTERING_WEAK = 'trust_sid_filtering_weak'
    TRUST_TGT_DELEGATION_ENABLED = 'trust_tgt_delegation_enabled'
    TRUST_RC4_DEPENDENCY = 'trust_rc4_dependency'
    TRUST_STALE_CONFIGURATION = 'trust_stale_configuration'
    AD_DNS_BROAD_ZONE_ACL = 'ad_dns_broad_zone_acl'
    AD_DNS_HIGH_RISK_NODE = 'ad_dns_high_risk_node'
    AD_DNS_STALE_DELEGATION = 'ad_dns_stale_delegation'
    HYBRID_CLOUD_KERBEROS_ACCOUNT = 'hybrid_cloud_kerberos_account'
    HYBRID_CLOUD_KERBEROS_STALE_KEY = 'hybrid_cloud_kerberos_stale_key'
    HYBRID_SEAMLESS_SSO_STALE_KEY = 'hybrid_seamless_sso_stale_key'
    HYBRID_ADFS_DKM_BROAD_ACL = 'hybrid_adfs_dkm_broad_acl'
    HYBRID_ENTRA_CONNECT_EXCESSIVE_RIGHTS = 'hybrid_entra_connect_excessive_rights'
    ATTACK_GRAPH_TIER0_PATH = 'attack_graph_tier0_path'
    ATTACK_GRAPH_CHOKEPOINT = 'attack_graph_chokepoint'

    # Evidence correlation and posture (Package C)
    EVENT_KERBEROS_RC4_OBSERVED = 'event_kerberos_rc4_observed'
    EVENT_KERBEROASTING_BURST = 'event_kerberoasting_burst'
    EVENT_ASREP_ACTIVITY = 'event_asrep_activity'
    EVENT_DCSYNC_ACTIVITY = 'event_dcsync_activity'
    EVENT_SENSITIVE_DIRECTORY_CHANGE = 'event_sensitive_directory_change'
    EVENT_CERTIFICATE_MAPPING_FAILURE = 'event_certificate_mapping_failure'
    EVENT_SUSPICIOUS_CERTIFICATE_ISSUANCE = 'event_suspicious_certificate_issuance'
    POSTURE_LDAP_SIGNING_WEAK = 'posture_ldap_signing_weak'
    POSTURE_CHANNEL_BINDING_WEAK = 'posture_channel_binding_weak'
    POSTURE_NTLM_RESTRICTION_WEAK = 'posture_ntlm_restriction_weak'
    POSTURE_SMB_SIGNING_WEAK = 'posture_smb_signing_weak'
    POSTURE_KERBEROS_RC4_ALLOWED = 'posture_kerberos_rc4_allowed'
    POSTURE_CERTIFICATE_MAPPING_WEAK = 'posture_certificate_mapping_weak'
    POSTURE_EVIDENCE_INCOMPLETE = 'posture_evidence_incomplete'
    SNAPSHOT_NEW_CRITICAL_RISK = 'snapshot_new_critical_risk'
    SNAPSHOT_PRIVILEGE_CHANGE = 'snapshot_privilege_change'
    SNAPSHOT_SECURITY_CONTROL_CHANGE = 'snapshot_security_control_change'
    SNAPSHOT_ATTACK_EDGE_ADDED = 'snapshot_attack_edge_added'
